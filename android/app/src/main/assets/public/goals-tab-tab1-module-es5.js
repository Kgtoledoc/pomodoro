(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["goals-tab-tab1-module"], {
    ...
    /***/
    function Zh7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function NoV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _pages_new_goals_new_goals_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../pages/new-goals/new-goals.page */
      "cWVS");

      var Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(alertController, nativeAudio, platform, tts, modalController) {
        ...
        _createClass(Tab1Page, [{
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      modal = _context.sent;
                      modal.onDidDismiss().then(function (goal) {
                        console.log(goal);

                        if (goal.data["dismissed"] != true) {
                          _this.taskStored = JSON.parse(localStorage.getItem("scheduledTasks")) ? JSON.parse(localStorage.getItem("scheduledTasks")) : [];
                        }
                      });
                      _context.next = 6;
          ...
          key: "extractTaskFromScheduledTask",
          value: function extractTaskFromScheduledTask(array) {
            var arr = [];
            array.forEach(function (e) {
              e.subtaskArray.forEach(function (element) {
    ...
    /***/
    function WK2t(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function yOxL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function z5PN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=goals-tab-tab1-module-es5.js.map