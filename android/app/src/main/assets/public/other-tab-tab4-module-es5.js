(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["other-tab-tab4-module"], {
    ...
    /***/
    function QE6N(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ZbJm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function fzFI(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            return __webpack_require__.e(
            /*! import() | expense-historic-tab-subtab2-module */
            "expense-historic-tab-subtab2-module").then(__webpack_require__.bind(null,
            /*! ../expense-historic-tab/subtab2.module */
            "Jp+F")).then(function (m) {
              return m.Subtab2PageModule;
            });
          }
        }, {
          path: "",
    ...
    /***/
    function vokQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function wLEG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var Tab4Page = /*#__PURE__*/function () {
        ...
        _createClass(Tab4Page, [{
          ...
          key: "navigateTo",
          value: function navigateTo(event, link) {
            ...
            console.log("".concat(url.join("/"), "/").concat(link));
            this.router.navigate(["".concat(url.join("/"), "/").concat(link)]);
          }
        }]);
...
//# sourceMappingURL=other-tab-tab4-module-es5.js.map